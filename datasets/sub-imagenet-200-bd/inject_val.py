...
inject = 'a'
data_dir = "../sub-imagenet-200/val/"

if not os.path.exists('inject_' + inject + '/val'):
    os.makedirs('inject_' + inject + '/val')
count = 0
im_path_list = []
...
for im_path in im_path_list:
    cmd = 'python /media/disk1/CVPR2021_invisible_backdoor/bd/trigger/encode_image.py ' \
    '/media/disk1/CVPR2021_invisible_backdoor/bd/trigger/saved_models_imagenet/1 ' \
        '--image {} ' \
            '--save_dir inject_{}/val/ ' \
