...
parser.add_argument('--out_dir', type=str,
                    default='/home/renge/Pycharm_Projects/ISSBA/datasets/imagenet-bd/inject_a/')
...
#     data_root = os.path.expanduser(os.path.join('/mnt/data03/renge/public_dataset/pytorch', 'cifar10-data'))
#
#     ds = []
#     if train:
